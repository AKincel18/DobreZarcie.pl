 ...
 * @author mateu
 */
public class Rejres extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
                ...
                case "UTWORZ KONTO": {
                    ...
                    try {
                        if (haslo.equals(haslo1)) {
                            Restaurator rest = new Restaurator(login, haslo);
                            databaseManagement.dodajEncje(new Object[]{rest}, utx);
                        } 
                    } catch (Exception e) {
        ...
        String url = "/Rejres.jsp";

        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher(url);

        dispatcher.forward(request, response);
        request.getRequestDispatcher("/Rejres.jsp").forward(request, response);
